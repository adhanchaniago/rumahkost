...
<div class="container">
  <div class="panel panel-default">&nbsp;
    <div class="panel-heading mb-3">
      <center>
        <h3 class="font-weight-bold">Input Transaksi Token Listrik
      </center>
      </h3>
    </div>
...
<div class="modal fade right" id="ModalTambahData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <button type="button" class="close px-0" data-dismiss="modal" aria-label="Close">
          <i class="fas fa-angle-right fa-fw text-primary mt-2"></i>
        </button>

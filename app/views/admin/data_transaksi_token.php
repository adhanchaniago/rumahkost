    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <tr class="text-center">
        ...
        <td class="align-middle">
          ...
          <?php else : ?>
            <a href="../../models/updates/a_berhasil_transaksi_token.php?id=<?= $row['id_transaksi'] ?>" class="btn btn-sm btn-primary rounded shadow-none waves-effect arsip" title="Arsip">
              <i class="fas fa-fw fa-folder-open"></i>
            </a>
          <?php endif; ?>
